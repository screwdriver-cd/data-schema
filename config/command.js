...
const COMMAND_EXACT_VERSION = Joi
    .string()
...
const SCHEMA_COMMAND = Joi.object()
    .keys({
        ...
        docker: CommandFormat.docker
            .when('format', { is: 'docker', then: Joi.required() }),
